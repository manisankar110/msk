...
<h3 class="text-primary" style=" margin-top:50px">Don't Worry you'll be back on track in no time!</h3>
...
Page doesnt occur or some other error occured. go to our <a href="http://www.talentex.in" class="text-danger">homepage</a> or go back to our <a href="http://www.talentex.in" class="text-danger">previous page</a></h4>
		...
		<div class="row">
			<div class="col-sm-6" style="margin-top:40px">
				...
				<p>© Copyright Fore Brain Technologies</p>
